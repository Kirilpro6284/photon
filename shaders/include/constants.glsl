...
6  | rgba16f | TAA render scale  | 4x4 max depth (deferred), volumetric fog transmittance (composite), taa min color (composite)
...
13 | rgba16  | TAA render scale  | previous frame depth, previous frame normals
14 | reserved for future use
15 | rgb11f  | 960x1080          | cloud shadow map (prepare -> deferred), bloom buffer (composite)
